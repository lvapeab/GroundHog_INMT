...
def parse_args():
    ...
    parser.add_argument("--prefix", action="store_true", default=False, help="Pos-edit only with prefixes (classic ITP)")
    ...
    parser.add_argument("--color", default=False, action="store_true", help="Colored hypotheses?")
