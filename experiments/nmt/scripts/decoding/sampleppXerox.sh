...
dest_file=/home/lvapeab/smt/tasks/xerox/enes/NMT/translations/xeroxfull-dev-500-520.es_norm
nbest_file=/home/lvapeab/smt/tasks/xerox/enes/NMT/translations/xeroxfull-dev-500-520.es.nbest
aligns_file=/home/lvapeab/smt/tasks/xerox/enes/NMT/translations/xeroxfull-dev-500-520.es.aligns
v=""

python ${sampler} --beam-search --beam-size ${beamsize}  --state ${state} ${model}  --source ${source_file} --trans ${dest_file} ${v} \
# --normalize --print-aligns ${aligns_file} # --nbest 50 --nbest-dest ${nbest_file}